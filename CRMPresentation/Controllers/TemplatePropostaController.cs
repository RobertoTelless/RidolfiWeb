...
namespace ERP_Condominios_Solution.Controllers
{
    public class TemplatePropostaController : Controller
    {
        ...
        public TemplatePropostaController(ITemplatePropostaAppService baseApps, ILogAppService logApps, IUsuarioAppService usuApps, IConfiguracaoAppService confApps)
        {
            baseApp = baseApps;
            logApp = logApps;
            usuApp = usuApps;
        ...
        public ActionResult FiltrarTemplateProposta(TEMPLATE_PROPOSTA item)
        {
            ...
            try
            {
                ...
                Session["FiltroTemplateProposta"] = item;
                Int32 volta = baseApp.ExecuteFilter(item.TEPR_SG_SIGLA, item.TEPR_NM_NOME, item.TEPR_TX_TEXTO, idAss, out listaObj);
        ...
        public ActionResult IncluirTemplateProposta()
        {
            ...
            if ((USUARIO)Session["UserCredentials"] != null)
            {
                ...
                {
                    Session["MensTemplateProposta"] = 2;
                    return RedirectToAction("MontarTelaTemplateProposta");
                }
            }
            else
