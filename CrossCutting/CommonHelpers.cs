...
namespace CrossCutting
{
	...
	public static class CommonHelpers
	{
        ...
        {
            Regex invalidCharsRgx = new Regex("[^_a-zA-Z0-9áâãéêíóôõúÁÂÃÉÊÍÓÔÕÚ]");
            ...
            var pascalCase = invalidCharsRgx.Replace(whiteSpace.Replace(original, "_"), " ")
        ...
        /// <summary>Compares the array.</summary>
        /// <param name="array1">The array1.</param>
        /// <param name="array2">The array2.</param>
        /// <returns>
        ///   <br />
        /// </returns>
        public static Boolean CompareArray(Int32[] array1, Int32[] array2)
        {
